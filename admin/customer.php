                    ...
                    <tbody>
                        <?php foreach($customers as $item) : ?>
                            <tr>
                                ...
                                <td>
                                    <!-- Edit and Delete links with confirmation for Delete -->
                                    <form action="customer-edit.php" method="post" style="display: inline-block; margin-right: 1px;">
                                    <input type="hidden" name="cusId" value="<?= validate($item['_id']) ?>">
                                        <button type="submit" class="btn btn-success btn-sm">Edit</button>
                                    </form>

                                    <form action="customer-delete.php" method="post" style="display: inline-block; margin-right: 1px;">
                                    <input type="hidden" name="cusId" value="<?= validate($item['_id']) ?>">
