...
if (isset($_SESSION['loggedInUser']['roleID'])) {
    switch ($_SESSION['loggedInUser']['roleID']) {
        case 1:
            $roleTitle = "Dashboard - Admin";
            break;
        case 2:
            $roleTitle = "Dashboard - Manager";
            break;
        case 3:
            $roleTitle = "Dashboard - Staff";
            break;
        default:
            $roleTitle = "Dashboard";
    }
...
<head>
    ...
    <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" data-auto-add-css="true" crossorigin="anonymous"></script>
