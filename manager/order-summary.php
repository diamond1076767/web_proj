			...
			<div class="card mt-4">
				...
				<div class="card-body">
						            		...
						            		<tr>
						          			...
						          			<tr>
						            			<td>
						            				...
						            				<p style="font-size: 14px; line-height: 20px; margin: 0px; padding: 0;">Customer Email Id: <?= validate(decryption($cRowData['email'])) ?></p>
						            			</td>
						              			<td align="end">
						            				<h5 style="font-size: 20px; line-height: 30px; margin: 0px; padding: 0;">Invoice Details</h5>
						            				<p style="font-size: 14px; line-height: 20px; margin: 0px; padding: 0;">Invoice No.: <?= validate($invoiceNo); ?></p>
						    			...
						    			<tbody>
						    				...
						    				<tr>
						    					...
						    					<td style="border-bottom: 1px solid #ccc;"><?php 
													...
													$stmt = mysqli_prepare($con, "SELECT colourName FROM colour WHERE _id=?");
													...
													mysqli_stmt_bind_result($stmt, $colorName);
						    				...
						    				<tr>
						    					...
						    					<td colspan="1" style="font-weight: bold;"><?= validate(number_format($totalAmount, 0)); ?></td>
						    				</tr>
						    				<tr>
					...
					<div class="mt-4 text-end">
						...
						<button class="btn btn-warning px-4 mx-1" onclick="downloadPDF('<?= validate($_SESSION['invoice_no']); ?>')">
						Download PDF</button>
					</div>
					<?php endif;?>
				</div>
