...
<div class="container" style="margin-top:60px">
    ...
    <form action="manager-code.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-3">
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" class="form-control" name="telephone" placeholder="Enter Phone Number" value="<?= $telephone?>" required />
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mt-3">
                                <div class="form-group">
